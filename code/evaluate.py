# Evaluate the trained model by FDL-Net based on two metrics, IoU and F-1 Score.
# Mltimedia-lab
import os
...
# evaluate the model on images in test set based on the metrics: IoU and F-1 Score and compute FLOPs
...
if __name__ == "__main__":
	print(BACKBONE)
	# evaluate the model on images in test set based on the metrics: IoU and F-1 Score 
	evaluate_test_data()		